...
<body>
  ...
  <div class="banner-text">
    ...
    <div class="call-us">
      <h1>Call Us</h1><a href="tel: 091692861">091692861</a>
    </div>
  ...
  <!-- Service -->
  <div class="service">
    <div class="delivery"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor"
    ...
    <div class="discount">
      <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-coin"
        viewBox="0 0 16 16">
        <path
    ...
    <div class="packing">
      <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-box-fill"
        viewBox="0 0 16 16">
        <path fill-rule="evenodd"
  ...
  <!-- Popular Our Food -->
  <div class="popularfood" id='popularfood'>
    <h1>Popular Our Food </h1>
    <p>Choose what you like</p>
    <div class="cards">
      <div class="card">
        <div class="pizza-img">
          <img src="img/pan veg.jpg" alt="">
        </div>
        <div class="pizzades">
          <h1>Pan Pizza (Veg)</h1>
      ...
      <div class="card">
        <div class="pizza-img">
          <img src="img/pan nonveg.jpg" alt="">
        </div>
        <div class="pizzades">
      ...
      <div class="card">
        <div class="pizza-img">
          <img src="img/cheese veg.jpg" alt="">
        </div>
        <div class="pizzades">
      ...
      <div class="card">
        <div class="pizza-img">
          <img src="img/cheese nonveg.jpg" alt="">
        </div>
        <div class="pizzades">
  ...
  <div id="slider-container">
    ...
    <div class="review">
      <p>
        <span>"</span>Wow I have found a great pizza place. They brought me a great pizza and the guy that delivered
        <span>"</span><br>
    ...
    <div class="review">
      <p>
        <span>"</span>I ordered Pizza for the first time & I’m so glad I did! I Can’t wait till I order again. Thick,
        tasty,<span>"</span><br>
  ...
  <footer>
    ...
    <div class="footer2">
      <div class="payment">
        ...
        <a href="https://khalti.com/login/"><img src="img/khalti.png" alt="" width="70px"></a>
        <a href="https://www.imepay.com.np/"><img src="img/ime.png" alt="" width="50px"></a>
        <a href="https://login.connectips.com/"><img src="img/ips.png" alt="" width="50px"></a>
      </div>
